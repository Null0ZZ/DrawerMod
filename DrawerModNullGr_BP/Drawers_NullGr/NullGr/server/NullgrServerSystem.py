...
class NullgrServerSystem(ServerSystem):
    """
    ...
    def __init__(self, namespace, systemName):
        super(NullgrServerSystem, self).__init__(namespace, systemName)
        self.allPlayerData = {}
    ...
    def lobbyGoodBuySucServerEvent(self, a):
        """
    ...
    def PlayerInventoryOpenScriptServerEvent(self, a):
        """
        某个客户端打开物品背包界面时触发。
    ...
    def WalkAnimEndServerEvent(self, a):
        """
        当走路动作结束时触发。
    ...
    def WalkAnimBeginServerEvent(self, a):
        """
        当走路动作开始时触发。
        使用SetModel替换骨骼模型后，该事件才生效。
        -----------------------------------------------------------
    ...
    def JumpAnimBeginServerEvent(self, a):
        """
        当跳跃动作开始时触发。
        使用SetModel替换骨骼模型后，该事件才生效。
        -----------------------------------------------------------
    ...
    def AttackAnimEndServerEvent(self, a):
        """
        当攻击动作结束时触发。
        使用SetModel替换骨骼模型后，该事件才生效。
        -----------------------------------------------------------
    ...
    def AttackAnimBeginServerEvent(self, a):
        """
        当攻击动作开始时触发。
        使用SetModel替换骨骼模型后，该事件才生效。
        -----------------------------------------------------------
    ...
    def UIContainerItemChangedServerEvent(self, a):
        """
        合成容器物品发生变化时触发。
    ...
    def ShearsUseToBlockBeforeServerEvent(self, a):
        """
        *tick*
    ...
    def ServerPlayerTryTouchEvent(self, a):
        """
        玩家即将捡起物品时触发。
        -----------------------------------------------------------
        【playerId: str】 玩家的实体ID
    ...
    def ServerItemTryUseEvent(self, a):
        """
    ...
    def PlayerDropItemServerEvent(self, a):
        """
        玩家丢弃物品时触发。
        -----------------------------------------------------------
        【playerId: str】 玩家的实体ID
    ...
    def OnPlayerBlockedByShieldBeforeServerEvent(self, a):
        """
        玩家使用盾牌抵挡伤害之前触发。
    ...
    def OnPlayerBlockedByShieldAfterServerEvent(self, a):
        """
        玩家使用盾牌抵挡伤害之后触发.
        -----------------------------------------------------------
        【playerId: str】 玩家的实体ID
    ...
    def OnPlayerActiveShieldServerEvent(self, a):
        """
    ...
    def OnOffhandItemChangedServerEvent(self, a):
        """
        玩家切换副手物品时触发该事件。
    ...
    def OnNewArmorExchangeServerEvent(self, a):
        """
        玩家切换盔甲时触发该事件。
    ...
    def OnItemPutInEnchantingModelServerEvent(self, a):
        """
        玩家将可附魔物品放到附魔台上时触发。
    ...
    def ItemUseOnAfterServerEvent(self, a):
        """
    ...
    def ItemUseAfterServerEvent(self, a):
        """
        玩家在使用物品之后服务端抛出的事件。
    ...
    def ItemReleaseUsingServerEvent(self, a):
        """
        释放正在使用的物品时触发。
        -----------------------------------------------------------
        【playerId: str】 玩家的实体ID
    ...
    def InventoryItemChangedServerEvent(self, a):
        """
        玩家背包物品变化时服务端抛出的事件。
        如果槽位变空，变化后槽位中物品为空气。
        触发时槽位物品仍为变化前物品。
    ...
    def FurnaceBurnFinishedServerEvent(self, a):
        """
    ...
    def CraftItemOutputChangeServerEvent(self, a):
        """
        玩家从容器拿出生成物品时触发。
        支持工作台，铁砧，砂轮等工作方块。
    ...
    def ContainerItemChangedServerEvent(self, a):
        """
        容器物品变化事件。
    ...
    def StepOnBlockServerEvent(self, a):
        """
        实体刚移动至一个新实心方块时触发。
    ...
    def StepOffBlockServerEvent(self, a):
        """
        实体移动离开一个实心方块时触发。
    ...
    def StartDestroyBlockServerEvent(self, a):
        """
        玩家开始挖方块时触发。创造模式下不触发。
    ...
    def ShearsDestoryBlockBeforeServerEvent(self, a):
        """
    ...
    def ServerPlayerTryDestroyBlockEvent(self, a):
        """
    ...
    def ServerPlaceBlockEntityEvent(self, a):
        """
    ...
    def ServerEntityTryPlaceBlockEvent(self, a):
        """
        当生物试图放置方块时触发该事件。
    ...
    def ServerBlockEntityTickEvent(self, a):
        """
        *tick*
    ...
    def PistonActionServerEvent(self, a):
        """
    ...
    def OnStandOnBlockServerEvent(self, a):
        """
        当实体站立到方块上时服务端持续触发。
        -----------------------------------------------------------
        【entityId: str】 实体ID
    ...
    def OnBeforeFallOnBlockServerEvent(self, a):
        """
    ...
    def OnAfterFallOnBlockServerEvent(self, a):
        """
    ...
    def HopperTryPullOutServerEvent(self, a):
        """
    ...
    def HopperTryPullInServerEvent(self, a):
        """
    ...
    def HeavyBlockStartFallingServerEvent(self, a):
        """
    ...
    def GrassBlockToDirtBlockServerEvent(self, a):
        """
        草方块变成泥土方块时触发。
        指令或者接口的设置不会触发该事件。
        -----------------------------------------------------------
    ...
    def FarmBlockToDirtBlockServerEvent(self, a):
        """
        耕地退化为泥土时触发。
        指令或者接口的设置不会触发该事件。
        -----------------------------------------------------------
    ...
    def FallingBlockReturnHeavyBlockServerEvent(self, a):
        """
    ...
    def FallingBlockCauseDamageBeforeServerEvent(self, a):
        """
    ...
    def FallingBlockBreakServerEvent(self, a):
        """
    ...
    def EntityPlaceBlockAfterServerEvent(self, a):
        """
        当生物成功放置方块后触发。
        部分放置后会产生实体的方块、可操作的方块、带有特殊逻辑的方块，不会触发该事件，包括但不限于床、门、告示牌、花盆、红石中继器、船、炼药锅、头部模型、蛋糕、酿造台、盔甲架等。
        -----------------------------------------------------------
    ...
    def DirtBlockToGrassBlockServerEvent(self, a):
        """
        泥土方块变成草方块时触发。
        指令或者接口的设置不会触发该事件。
        -----------------------------------------------------------
    ...
    def CommandBlockUpdateEvent(self, a):
        """
        玩家尝试修改命令方块的内置命令时。
    ...
    def CommandBlockContainerOpenEvent(self, a):
        """
    ...
    def ChestBlockTryPairWithServerEvent(self, a):
        """
    ...
    def BlockStrengthChangedServerEvent(self, a):
        """
    ...
    def BlockSnowStateChangeServerEvent(self, a):
        """
        方块转为含雪或者脱离含雪前触发。
        -----------------------------------------------------------
        【dimension: int】 维度ID
    ...
    def BlockSnowStateChangeAfterServerEvent(self, a):
        """
        方块转为含雪或者脱离含雪后触发。
        -----------------------------------------------------------
        【dimension: int】 维度ID
    ...
    def BlockRemoveServerEvent(self, a):
        """
    ...
    def BlockRandomTickServerEvent(self, a):
        """
    ...
    def BlockNeighborChangedServerEvent(self, a):
        """
    ...
    def BlockLiquidStateChangeServerEvent(self, a):
        """
        方块转为含水或者脱离含水(流体)前触发。
        -----------------------------------------------------------
        【blockName: str】 方块的identifier，包含命名空间及名称
    ...
    def BlockLiquidStateChangeAfterServerEvent(self, a):
        """
        方块转为含水或者脱离含水(流体)后触发。
        -----------------------------------------------------------
        【blockName: str】 方块的identifier，包含命名空间及名称
    ...
    def BlockDestroyByLiquidServerEvent(self, a):
        """
        方块被水流破坏的事件。
        指令或者接口的设置不会触发该事件。
        -----------------------------------------------------------
    ...
    def StoreBuySuccServerEvent(self, a):
        """
        玩家游戏内购买商品时服务端抛出的事件。
        -----------------------------------------------------------
        【playerId: str】 玩家的实体ID
    ...
    def ServerPlayerGetExperienceOrbEvent(self, a):
        """
        玩家获取经验球时触发的事件。
    ...
    def PlayerTrySleepServerEvent(self, a):
        """
        玩家尝试使用床睡觉时触发。
        -----------------------------------------------------------
        【playerId: str】 玩家的实体ID
    ...
    def PlayerTeleportEvent(self, a):
        """
    ...
    def PlayerStopSleepServerEvent(self, a):
        """
        玩家停止睡觉时触发。
        -----------------------------------------------------------
        【playerId: str】 玩家的实体ID
    ...
    def PlayerSleepServerEvent(self, a):
        """
        玩家使用床睡觉成功时触发。
        -----------------------------------------------------------
        【playerId: str】 玩家的实体ID
    ...
    def PlayerRespawnFinishServerEvent(self, a):
        """
        玩家复活完毕时触发。
    ...
    def PlayerEatFoodServerEvent(self, a):
        """
        玩家吃下食物时触发。
        吃蛋糕以及喝牛奶不触发该事件。
        -----------------------------------------------------------
    ...
    def OnPlayerHitBlockServerEvent(self, a):
        """
    ...
    def GameTypeChangedServerEvent(self, a):
        """
        个人游戏模式发生变化时服务端触发。
    ...
    def ExtinguishFireServerEvent(self, a):
        """
        玩家扑灭火焰时触发。
        下雨，倒水等方式熄灭火焰不会触发。
        -----------------------------------------------------------
    ...
    def DimensionChangeServerEvent(self, a):
        """
        玩家维度改变时服务端抛出。
    ...
    def ChangeLevelUpCostServerEvent(self, a):
        """
    ...
    def WillTeleportToServerEvent(self, a):
        """
        实体即将传送或切换维度时触发。
    ...
    def WillAddEffectServerEvent(self, a):
        """
        实体即将获得状态效果前触发。
        -----------------------------------------------------------
        【entityId: str】 实体ID
    ...
    def StartRidingServerEvent(self, a):
        """
        一个实体即将骑乘另外一个实体时触发。
        -----------------------------------------------------------
    ...
    def RemoveEffectServerEvent(self, a):
        """
        实体身上状态效果被移除时触发。
        -----------------------------------------------------------
        【entityId: str】 实体ID
    ...
    def RefreshEffectServerEvent(self, a):
        """
    ...
    def ProjectileCritHitEvent(self, a):
        """
        当抛射物与头部碰撞时触发该事件。
    ...
    def OnMobHitMobServerEvent(self, a):
        """
    ...
    def OnKnockBackServerEvent(self, a):
        """
        实体被击退时触发。
        -----------------------------------------------------------
        【id: str】 实体ID
    ...
    def MobGriefingBlockServerEvent(self, a):
        """
    ...
    def HealthChangeServerEvent(self, a):
        """
        生物生命值发生变化时触发。
        -----------------------------------------------------------
        【entityId: str】 实体ID
    ...
    def EntityTickServerEvent(self, a):
        """
        *tick*
    ...
    def EntityPickupItemServerEvent(self, a):
        """
    ...
    def EntityMotionStopServerEvent(self, a):
        """
    ...
    def EntityMotionStartServerEvent(self, a):
        """
    ...
    def EntityLoadScriptEvent(self, a):
        """
        数据库加载实体自定义数据时触发。
        只有使用过extraData组件的SetExtraData接口的实体才有此事件，触发时可以通过extraData组件的GetExtraData或GetWholeExtraData接口获取该实体的自定义数据。
        -----------------------------------------------------------
        【a: list】 该事件的参数为长度为2的list，而非dict，其中list的第一个元素为实体ID
        """

    def EntityEffectDamageServerEvent(self, a):
        """
        生物受到状态伤害/回复事件。
        -----------------------------------------------------------
        【entityId: str】 实体ID
    ...
    def EntityDroppedItemServerEvent(self, a):
        """
        生物扔出物品时触发。
        -----------------------------------------------------------
    ...
    def EntityChangeDimensionServerEvent(self, a):
        """
        实体维度改变时服务端抛出。
    ...
    def ChangeSwimStateServerEvent(self, a):
        """
        实体开始或者结束游泳时触发。
    ...
    def AddEffectServerEvent(self, a):
        """
        实体获得状态效果时触发。
        -----------------------------------------------------------
        【entityId: str】 实体ID
    ...
    def ActorHurtServerEvent(self, a):
        """
        生物（包括玩家）受伤时触发。
        -----------------------------------------------------------
        【entityId: str】 实体ID
    ...
    def ServerSpawnMobEvent(self, a):
        """
    ...
    def ServerPreBlockPatternEvent(self, a):
        """
    ...
    def ServerPostBlockPatternEvent(self, a):
        """
    ...
    def PlayerLeftMessageServerEvent(self, a):
        """
    ...
    def PlayerJoinMessageEvent(self, a):
        """
    ...
    def PlayerIntendLeaveServerEvent(self, a):
        """
        即将删除玩家时触发该事件。
    ...
    def PlaceNeteaseStructureFeatureEvent(self, a):
        """
    ...
    def OnRainLevelChangeServerEvent(self, a):
        """
        下雨强度发生改变时触发。
        -----------------------------------------------------------
    ...
    def OnLocalRainLevelChangeServerEvent(self, a):
        """
        独立维度天气下雨强度发生改变时触发。
        -----------------------------------------------------------
        【oldLevel: float】 改变前的下雨强度
    ...
    def OnLocalLightningLevelChangeServerEvent(self, a):
        """
        独立维度天气打雷强度发生改变时触发。
        -----------------------------------------------------------
    ...
    def OnLightningLevelChangeServerEvent(self, a):
        """
        打雷强度发生改变时触发。
        -----------------------------------------------------------
        【oldLevel: float】 改变前的打雷强度
    ...
    def OnContainerFillLoottableServerEvent(self, a):
        """
    ...
    def OnCommandOutputServerEvent(self, a):
        """
        Command命令执行成功事件。
    ...
    def NewOnEntityAreaEvent(self, a):
        """
    ...
    def LoadServerAddonScriptsAfter(self, a):
        """
        服务器加载完mod时触发。
        -----------------------------------------------------------
        无参数
    ...
    def DelServerPlayerEvent(self, a):
        """
        删除玩家时触发该事件。
        -----------------------------------------------------------
        【id: str】 玩家的实体ID
    ...
    def ClientLoadAddonsFinishServerEvent(self, a):
        """
    ...
    def ChunkLoadedServerEvent(self, a):
        """
        服务端区块加载完成时。
        -----------------------------------------------------------
        【dimension: int】 维度ID
    ...
    def ChunkGeneratedServerEvent(self, a):
        """
        区块创建完成时触发。
        -----------------------------------------------------------
        【dimension: int】 维度ID
    ...
    def ChunkAcquireDiscardedServerEvent(self, a):
        """
        服务端区块即将被卸载时触发。
    ...
    def AddServerPlayerEvent(self, a):
        """
        玩家加入时触发该事件。
    ...
    def AchievementCompleteEvent(self, a):
        """
        玩家完成自定义成就时触发该事件。
        -----------------------------------------------------------
        【playerId: str】 玩家的实体ID
    ...
    def PlayerAttackEntityEvent(self, a):
        """
        当玩家攻击时触发该事件。
        -----------------------------------------------------------
        【playerId: str】 玩家的实体ID
    ...
    def ServerBlockUseEvent(self, a):
        """
        *tick*
    ...
    def OnGroundServerEvent(self, a):
        """
    ...
    def SpawnProjectileServerEvent(self, a):
        """
        抛射物生成时触发。
    ...
    def EntityDieLoottableServerEvent(self, a):
        """
        生物死亡掉落物品时触发。
        只有当dirty为True时才会重新读取item列表并生成对应的掉落物，如果不需要修改掉落结果的话请勿随意修改dirty值。
        -----------------------------------------------------------
    ...
    def ActuallyHurtServerEvent(self, a):
        """
    ...
    def HealthChangeBeforeServerEvent(self, a):
        """
        生物生命值发生变化之前触发。
        -----------------------------------------------------------
        【entityId: str】 实体ID
    ...
    def DimensionChangeFinishServerEvent(self, a):
        """
        玩家维度改变完成后服务端抛出。
    ...
    def EntityDefinitionsEventServerEvent(self, a):
        """
    ...
    def PlayerDoInteractServerEvent(self, a):
        """
    ...
    def PlayerInteractServerEvent(self, a):
        """
        玩家可以与实体交互时触发。
    ...
    def AddEntityServerEvent(self, a):
        """
    ...
    def OnMobHitBlockServerEvent(self, a):
        """
    ...
    def OnEntityInsideBlockServerEvent(self, a):
        """
        *tick*
    ...
    def EntityStartRidingEvent(self, a):
        """
        当实体骑乘上另一个实体时触发。
        -----------------------------------------------------------
        【id: str】 骑乘者实体ID
    ...
    def EntityStopRidingEvent(self, a):
        """
        当实体停止骑乘时触发。
        以下情况不允许取消：
    ...
    def ServerItemUseOnEvent(self, a):
        """
        *tick*
    ...
    def ActorUseItemServerEvent(self, a):
        """
        玩家使用物品生效之前服务端抛出的事件。
        比较特殊不走该事件的例子：
        1. 喝牛奶；
    ...
    def ActorAcquiredItemServerEvent(self, a):
        """
    ...
    def ExplosionServerEvent(self, a):
        """
        当发生爆炸时触发。
    ...
    def ProjectileDoHitEffectEvent(self, a):
        """
        当抛射物碰撞时触发该事件。
        -----------------------------------------------------------
        【id: str】 子弹的实体ID
    ...
    def OnCarriedNewItemChangedServerEvent(self, a):
        """
        玩家切换主手物品时触发该事件。
